...
mod tests {
    ...
    #[test]
    fn curb_opening_exceeds_grate_at_deep_flow() {
        // At shallow depth the grate exponent (1.5) wins; curb overtakes at ~1 ft depth.
        let g = grate_capacity_cfs(4.0, 1.0, 0.005);
        let c = curb_opening_capacity_cfs(4.0, 1.0, 0.005);
        assert!(c > g);
    }
